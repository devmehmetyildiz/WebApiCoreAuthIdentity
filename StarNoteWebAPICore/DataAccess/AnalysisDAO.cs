...
{
    public class AnalysisDAO : BaseDAO
    {
        ...
        public List<AnalysisMontlyModel> Fillmontlyanalysis(string datefilter,string type)
        {
            ...
            stoknamesall = objcontext.tbl_joborder.Select(u => u.Ürün2).Distinct().ToList();
            foreach (var item in stoknamesall)
            {
                if (type == harcamaaylık || type == ekgeliraylık)
                {
                    if (objcontext.tbl_stok.SingleOrDefault(u => u.Stokadı == item) == null)
                        stoknames.Add(item);
                }
                else
                {
        ...
        public List<string> monthanalysispotansialgaugefill(string datefilter,string Tür)
        {
            List<string> output = new List<string>();
                ...
                if (Tür == genelaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year) select c.Beklenentutar).Sum().ToString();
                if (Tür == adliyeaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür != "ÖZEL MÜŞTERİLER" && c.Tür != "ŞİRKETLER") select c.Beklenentutar).Sum().ToString();
                if (Tür == özelaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ÖZEL MÜŞTERİLER") select c.Beklenentutar).Sum().ToString();
        ...
        public List<string> monthanalysissalesgaugefill(string datefilter,string Tür)
        {
            List<string> output = new List<string>();
            try
            {
                ...
                string item = string.Empty;              
                if (Tür == genelaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year) select c.Ücret).Sum().ToString();
                if (Tür == adliyeaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür != "ÖZEL MÜŞTERİLER" && c.Tür != "ŞİRKETLER") select c.Ücret).Sum().ToString();
                if (Tür == özelaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ÖZEL MÜŞTERİLER") select c.Ücret).Sum().ToString();
                if (Tür == digerkurumaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ŞİRKETLER") select c.Ücret).Sum().ToString();
                if (Tür == harcamaaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Savetype == 1 && c.Satışyöntemi == "GIDER") select c.Ücret).Sum().ToString();
                if (Tür == ekgeliraylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Savetype == 1 && c.Satışyöntemi == "GELIR") select c.Ücret).Sum().ToString();
                if (item == string.Empty)
                    item = "0";
                output.Add(item);
            }
        ...
        public List<string> monthanalysispurchasegaugefill(string datefilter,string Tür)
        {
            List<string> output = new List<string>();
                ...
                string item = string.Empty;
                if (Tür == genelaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year) select c.Ücret).Sum().ToString();
                if (Tür == adliyeaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür!= "ÖZEL MÜŞTERİLER" && c.Tür!= "ŞİRKETLER") select c.Ücret).Sum().ToString();
                if (Tür == özelaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ÖZEL MÜŞTERİLER") select c.Ücret).Sum().ToString();
                if (Tür == digerkurumaylık)
        ...
        public List<string> monthanalysisnetgaugefill(string datefilter, string Tür)
        {
            List<string> output = new List<string>();
            try
            {
                ...
                if (Tür == genelaylık)
                {
                    outcome = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year) select c.Ücret).Sum().ToString();
                    income = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year) select c.Ücret).Sum().ToString();
                }                    
                if (Tür == adliyeaylık)
                {
                    outcome = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür != "ÖZEL MÜŞTERİLER" && c.Tür != "ŞİRKETLER") select c.Ücret).Sum().ToString();
                    income = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür != "ÖZEL MÜŞTERİLER" && c.Tür != "ŞİRKETLER") select c.Ücret).Sum().ToString();
                }                   
                if (Tür == özelaylık)
                {
                    outcome = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ÖZEL MÜŞTERİLER") select c.Ücret).Sum().ToString();
                    income = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ÖZEL MÜŞTERİLER") select c.Ücret).Sum().ToString();
                }                    
                if (Tür == digerkurumaylık)
                {
                    outcome = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ŞİRKETLER") select c.Ücret).Sum().ToString();
                    income = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ŞİRKETLER") select c.Ücret).Sum().ToString();
                }                    
                if (Tür == harcamaaylık)
                {
                    outcome = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Savetype == 1 && c.Satışyöntemi == "GIDER") select c.Ücret).Sum().ToString();
                    income = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Savetype == 1 && c.Satışyöntemi == "GIDER") select c.Ücret).Sum().ToString();
                }                   
                if (Tür == ekgeliraylık)
                {
                    outcome = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Savetype == 1 && c.Satışyöntemi == "GELIR") select c.Ücret).Sum().ToString();
                    income = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(3, 2) == month && c.Randevutarihi.Substring(6, 4) == year && c.Savetype == 1 && c.Satışyöntemi == "GELIR") select c.Ücret).Sum().ToString();
                }                                  
        ...
        public List<string> yearlyanalysispotansialgaugefill(string datefilter, string Tür)
        {
            List<string> output = new List<string>();
                ...
                string item = string.Empty;
                if (Tür == genelyıllık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year) select c.Beklenentutar).Sum().ToString();
                if (Tür == adliyeyıllık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year && c.Tür != "ÖZEL MÜŞTERİLER" && c.Tür != "ŞİRKETLER") select c.Beklenentutar).Sum().ToString();
                if (Tür == özelyıllık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ÖZEL MÜŞTERİLER") select c.Beklenentutar).Sum().ToString();
                if (Tür == digerkurumyıllık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ŞİRKETLER") select c.Beklenentutar).Sum().ToString();
                if (Tür == harcamayıllık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year && c.Savetype == 1 && c.Satışyöntemi == "GIDER") select c.Beklenentutar).Sum().ToString();
                if (Tür == ekgeliryıllık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year && c.Savetype == 1 && c.Satışyöntemi == "GELIR") select c.Beklenentutar).Sum().ToString();
                if (item == string.Empty)
                    item = "0";                
                output.Add(item);
        ...
        public List<string> yearlyanalysissalesgaugefill(string datefilter, string Tür)
        {
            List<string> output = new List<string>();
            try
            {
                ...
                string item = string.Empty;
                if (Tür == genelyıllık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year) select c.Ücret).Sum().ToString();
                if (Tür == adliyeyıllık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year && c.Tür != "ÖZEL MÜŞTERİLER" && c.Tür != "ŞİRKETLER") select c.Ücret).Sum().ToString();
                if (Tür == özelyıllık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ÖZEL MÜŞTERİLER") select c.Ücret).Sum().ToString();
                if (Tür == digerkurumyıllık)
        ...
        public List<string> yearlyanalysispurchasegaugefill(string datefilter, string Tür)
        {
            List<string> output = new List<string>();
                ...
                string item = string.Empty;
                if (Tür == genelaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(6, 4) == year) select c.Ücret).Sum().ToString();
                if (Tür == adliyeaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(6, 4) == year && c.Tür != "ÖZEL MÜŞTERİLER" && c.Tür != "ŞİRKETLER") select c.Ücret).Sum().ToString();
                if (Tür == özelaylık)
                    item = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ÖZEL MÜŞTERİLER") select c.Ücret).Sum().ToString();
                if (Tür == digerkurumaylık)
        ...
        public List<string> yearlyanalysisnetgaugefill(string datefilter, string Tür)
        {
            List<string> output = new List<string>();
                ...
                if (Tür == genelaylık)
                {
                    outcome = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(6, 4) == year) select c.Ücret).Sum().ToString();
                    income = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year) select c.Ücret).Sum().ToString();
                }
                if (Tür == adliyeaylık)
                {
                    outcome = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(6, 4) == year && c.Tür != "ÖZEL MÜŞTERİLER" && c.Tür != "ŞİRKETLER") select c.Ücret).Sum().ToString();
                    income = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year && c.Tür != "ÖZEL MÜŞTERİLER" && c.Tür != "ŞİRKETLER") select c.Ücret).Sum().ToString();
                }
                if (Tür == özelaylık)
                {
                    outcome = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ÖZEL MÜŞTERİLER") select c.Ücret).Sum().ToString();
                    income = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ÖZEL MÜŞTERİLER") select c.Ücret).Sum().ToString();
                }
                if (Tür == digerkurumaylık)
                {
                    outcome = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ŞİRKETLER") select c.Ücret).Sum().ToString();
                    income = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year && c.Tür == "ŞİRKETLER") select c.Ücret).Sum().ToString();
                }
                if (Tür == harcamaaylık)
                {
                    outcome = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(6, 4) == year && c.Savetype == 1 && c.Satışyöntemi == "GIDER") select c.Ücret).Sum().ToString();
                    income = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year && c.Savetype == 1 && c.Satışyöntemi == "GIDER") select c.Ücret).Sum().ToString();
                }
                if (Tür == ekgeliraylık)
                {
                    outcome = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satınalma && c.Randevutarihi.Substring(6, 4) == year && c.Savetype == 1 && c.Satışyöntemi == "GELIR") select c.Ücret).Sum().ToString();
                    income = (from c in objcontext.tbl_customerorder where (c.Satışyöntemi == Satış && c.Randevutarihi.Substring(6, 4) == year && c.Savetype == 1 && c.Satışyöntemi == "GELIR") select c.Ücret).Sum().ToString();
                }
                if (outcome.Trim() == string.Empty)
                    outcome = "0";
                if (income.Trim() == string.Empty)
        ...
        public List<SalesmanAnalysisModel> Fillsalesmantablesales(string datefilter)
        {
            ...
            try
            {
                salesmans = objcontext.tbl_salesman.Select(u => u.Parameter).ToList();
